...
#[Fillable(['name', 'email', 'mobile_number', 'password', 'roles', 'latitude', 'longitude', 'current_location', 'vehicles', 'selected_vehicle_id', 'profile_photo', 'drivers_license_photo', 'is_online', 'driver_verification_status'])]
